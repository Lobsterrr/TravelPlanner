            ...
            <div className="planContainer">
                ...
                <div className="path">
                    <Button type="primary" htmlType="submit" onClick={this.generateRoute} className="btn-3d cyan">Generate
                        Route</Button>
                    <Button type="primary" htmlType="submit" onClick={this.removeRoute} className="btn-3d red">Remove
                        Route</Button>
                    <Button type="primary" htmlType="submit" onClick={this.recommendRoute} className="btn-3d purple">Recommend
                        Route</Button>
